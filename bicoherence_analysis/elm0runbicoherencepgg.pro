...
print,totalfilename
  ...
  parameters = ELMcreateParameterStruct(blocksize, timeax, chName, shotnumber, expname, maxFreq ,optScale,ELMselect, 'bicoherence'+'ELM0level='+ELMszint)
  ...
  optScale=0.7
  parameters = ELMcreateParameterStruct(blocksize, timeax, chName, shotnumber, expname, maxFreq ,optScale, ELMselect, 'confidence'+'ELM0level='+ELMszint)
  ...
  parameters = ELMcreateParameterStruct(blocksize, timeax, chName, shotnumber, expname,$
    maxFreq ,optScale,ELMselect, 'filtered_at_'+pg_num2str(confLevel, length=5)+' ELM0level='+ELMszint)
;    parameters=parameters+'ELMlevel='+ELMszint
