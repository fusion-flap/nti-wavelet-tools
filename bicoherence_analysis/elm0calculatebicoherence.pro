;********************************************************************************************************
; Name: ELM0calculateBicoherence.pro
; 
; PURPOSE
; =======
...
;********************************************************************************************************
function ELM0calculateBicoherence, rawSignal, singleBlockSize,ELMlevel, APSD=APSD
...
;  endif
  ...
  cutSignal = ELM0windowSignal(rawSignal,singleBlockSize,ELMlevel, how='not_overlapping_hanning')
